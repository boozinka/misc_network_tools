...
""" DNS Resolver, reads a file and does a forward or reverse
    DNS lookup and writes output to a new file
"""
...
def set_working_dir():
    """ Welcome screen and setup for initial parameters including the working 
...
def get_file(working_dir):
    ...
    while not file_input:
        ...
        file_name = input("\nPlease enter the full input file name: ")
...
def forward_dns(host_str):
    ...
    if choice == "0":
        ...
        # concatanates both resolved and unresolved dictionaries
